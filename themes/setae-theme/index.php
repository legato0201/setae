...
if (!is_user_logged_in()) {
    ...
    <div id="setae-login-screen"
        ...
        <div class="setae-card" style="text-align:center; padding:40px 90px; max-width:400px;">
            <h1 class="setae-logo-text" style="margin-bottom:20px; font-size: 36px;">SETAE</h1>
            <p style="margin-bottom:30px;">タランチュラ愛好家のための統合プラットフォーム</p>
            <a href="<?php echo wp_login_url(home_url()); ?>" class="setae-btn">ログインして開始</a>
            <?php if (get_option('setae_enable_registration')): ?>
            ...
            <?php endif; ?>
            <p style="margin-top:20px; font-size:12px; color:#999;">&copy; 中野かえる商店</p>
        </div>
    </div>
